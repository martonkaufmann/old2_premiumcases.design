    ...
    <Layout>
        ...
        <section className="mx-0 xl:mx-40 px-4 xl:px-0">
            ...
            <article>
                ...
                <h1 className="text-lg mb-4 mt-12">Cookies</h1>
                <p>
                ...
                <h1 className="text-lg mb-4 mt-12">License</h1>
                <p>
                ...
                <h1 className="text-lg mb-4 mt-12">Iframes</h1>
                <p>
                ...
                <h1 className="text-lg mb-4 mt-12">Reservation of Rights</h1>
                <p>
                ...
                <h1 className="text-lg mb-4 mt-12">Content Liability</h1>
                <p>
                ...
                <h1 className="text-lg mb-4 mt-12">Disclaimer</h1>
                <p>
